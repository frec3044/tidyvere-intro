...
Which reservoir has the highest observed surface chlorophyll-a? (you will use a group_by and summerize)
...
Hints: You will need to use `group_by`, `summarize`, [`pivot_wider`](https://r4ds.hadley.nz/data-tidy.html#widening-data), and `mutate` to transform the cleaned dataset from Exercise 3 into a table that can be used to generate this plot. You should have one plot with one line and points.
